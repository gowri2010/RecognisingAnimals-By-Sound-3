...
function gotResults(error, results) {
    if (error) {
        ...
        document.getElementById("detected").innerHTML = "Detected Dog - "+dog+"Detected Cat - "+cat+"Detected Lion - "+lion+"Detected Cow - ";
        document.getElementById("detected").style.color = "rgb("+random_number_r+","+random_number_g+","+random_number_b+")";

        document.gotElementById("animal_voices").innerHTML = "Detected Voice Is Of - " +results[0].label;
